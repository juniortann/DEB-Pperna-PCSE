...
temp.tL_Uba    = C2K(25);  units.temp.tL_Uba = 'K'; label.temp.tL_Uba = 'temperature';
...
% %  
%   weights.tL_SBr = 0 * weights.tL_SBr;
% %   weights.tL_ItaBr = 5 * weights.tL_ItaBr;
% %   weights.tW_ItaBr = 5 * weights.tW_ItaBr;
%   weights.tL_Uba = 0 * weights.tL_Uba;
%   weights.Lt_Flor = 0 * weights.Lt_Flor;
%  
